...
public class Bills extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Spinner spinner = (Spinner) findViewById(R.id.bills_spinner);
		...
		Spinner spinner2 = (Spinner) findViewById(R.id.accounts_spinner);
	...
	public void billsClick(View view){
		EditText amount = (EditText) findViewById(R.id.billAmountInput);
		amount.setText("");
