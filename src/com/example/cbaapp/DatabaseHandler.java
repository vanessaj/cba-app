...
public class DatabaseHandler extends SQLiteOpenHelper{
    ...
    private static String DB_PATH = "/data/data/com.example.cbaapp/databases/";
 
    private static String DB_NAME = "soldes.db";
    ...
    private static final String DB_TABLE_TX = "soldes";
  ...
  /**
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		db.execSQL("DROP TABLE IF EXISTS "+DB_TABLE_TX);
        onCreate(db);
	}
   ...
   */
	public Cursor fetchAllTransactions(){
    	...
    	myData.compileStatement("CREATE TABLE IF NOT EXISTS places (_id INTEGER, name TEXT, amount NUMERIC, date TEXT)");
    	
    	c = myData.rawQuery("SELECT * FROM soldes", null);
